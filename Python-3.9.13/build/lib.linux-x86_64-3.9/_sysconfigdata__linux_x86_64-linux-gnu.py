...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-ar',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': '/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-cc '
              '-pthread -shared -Wl,-O2 -Wl,--sort-common -Wl,--as-needed '
              '-Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags '
              '-Wl,--gc-sections -Wl,-rpath,/mnt/d/projekt/nanoai_env/lib '
              '-Wl,-rpath-link,/mnt/d/projekt/nanoai_env/lib '
              '-L/mnt/d/projekt/nanoai_env/lib',
 'BUILDEXE': '.exe',
 'BUILDPYTHON': 'python.exe',
 'BUILD_GNU_TYPE': 'x86_64-conda-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': '/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-cc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
           '-march=nocona -mtune=haswell -ftree-vectorize -fPIC '
           '-fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe '
           '-isystem /mnt/d/projekt/nanoai_env/include',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CFLAGS_NODIST': '',
 ...
 'CONFIGURE_CFLAGS': '-march=nocona -mtune=haswell -ftree-vectorize -fPIC '
                     ...
                     '/mnt/d/projekt/nanoai_env/include',
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                      ...
                      '-Wl,-rpath,/mnt/d/projekt/nanoai_env/lib '
                      '-Wl,-rpath-link,/mnt/d/projekt/nanoai_env/lib '
                      '-L/mnt/d/projekt/nanoai_env/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--enable-optimizations' 'build_alias=x86_64-conda-linux-gnu' "
                "'host_alias=x86_64-conda-linux-gnu' "
                "'CC=/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-cc' "
                "'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC "
                '-fstack-protector-strong -fno-plt -O2 -ffunction-sections '
                "-pipe -isystem /mnt/d/projekt/nanoai_env/include' "
                "'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed "
                '-Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags '
                '-Wl,--gc-sections -Wl,-rpath,/mnt/d/projekt/nanoai_env/lib '
                '-Wl,-rpath-link,/mnt/d/projekt/nanoai_env/lib '
                "-L/mnt/d/projekt/nanoai_env/lib' 'CPPFLAGS=-DNDEBUG "
                '-D_FORTIFY_SOURCE=2 -O2 -isystem '
                "/mnt/d/projekt/nanoai_env/include' "
                "'CPP=/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-cpp'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/mnt/d/gra/Python-3.9.13/coverage.info',
 'COVERAGE_REPORT': '/mnt/d/gra/Python-3.9.13/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
             '/mnt/d/projekt/nanoai_env/include',
 'CXX': '/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-c++ -pthread',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-c++ '
                '-pthread -shared',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': '/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-cc -pthread '
 ...
 'LINKCC': '/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-cc -pthread',
 ...
 'MAINCC': '/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-cc -pthread',
 'MAJOR_IN_MKDEV': 0,
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   ...
                   '-fstack-protector-strong -fno-plt -O2 -ffunction-sections '
                   '-pipe -isystem /mnt/d/projekt/nanoai_env/include -std=c99 '
                   '-Wextra -Wno-unused-result -Wno-unused-parameter '
                   '-Wno-missing-field-initializers '
                   '-Werror=implicit-function-declaration -fvisibility=hidden  '
                   '-I./Include/internal -I. -I./Include -DNDEBUG '
                   '-D_FORTIFY_SOURCE=2 -O2 -isystem '
                   '/mnt/d/projekt/nanoai_env/include -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                    '-Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections '
                    '-Wl,-rpath,/mnt/d/projekt/nanoai_env/lib '
                    '-Wl,-rpath-link,/mnt/d/projekt/nanoai_env/lib '
                    '-L/mnt/d/projekt/nanoai_env/lib',
 'PY_CPPFLAGS': '-I. -I./Include -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                '/mnt/d/projekt/nanoai_env/include',
 'PY_FORMAT_SIZE_T': '"z"',
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -march=nocona -mtune=haswell '
                        '-ftree-vectorize -fPIC -fstack-protector-strong '
                        '-fno-plt -O2 -ffunction-sections -pipe -isystem '
                        '/mnt/d/projekt/nanoai_env/include -std=c99 -Wextra '
                        '-Wno-unused-result -Wno-unused-parameter '
                        '-Wno-missing-field-initializers '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I./Include/internal -I. '
                        '-I./Include -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                        '/mnt/d/projekt/nanoai_env/include',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 0,
 'Py_HASH_ALGORITHM': 0,
 ...
 'READELF': '/mnt/d/projekt/nanoai_env/bin/x86_64-conda-linux-gnu-readelf',
 ...
 'abs_builddir': '/mnt/d/gra/Python-3.9.13',
 'abs_srcdir': '/mnt/d/gra/Python-3.9.13',
